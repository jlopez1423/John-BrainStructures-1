...
d3.json("../static/slices_rep.json", function (filenames) {
    d3.select("#brain")
        .append("svg:svg")
        .attr("id", "brain_svg")
        .attr("width", w)
    ...
    for (var i = 0; i < filenames.length; i++) {
      d3.xml("../static/svgslices/" + filenames[i], "images/svg+xml", function (xml) {
...
d3.json("../static/allen.json", function(root) {
